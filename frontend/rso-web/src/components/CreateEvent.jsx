...
class PublicEventDBO {
  constructor(title, category, description, starttime, endtime, address, city, state, lat, lon, postal_code) {
    this.title = title;
...
class PublicEventDBO {
  constructor(title, category, description, starttime, endtime, address, lat, lon) {
    this.title = title;
    this.category = category;
    this.description = description;
    this.starttime = starttime;
...
class CreateEvent extends Component {
  ...
  handleSubmitCreateEvent() {
    ...
    var x = new Date(this.refs.eventStartDate.value);
    ...
    console.log(
      JSON.stringify({
        ...
        starttime : together,
        endtime : together2,
        address: this.refs.eventAddress.value,
        city: "cool",
        state: "non",
...
//var eventObject = new PublicEventDBO("are we in the server?", "Project", "Hope this shit works", "start", "end", "3900 Fudge St.", "Orlando", "FL", "-342.99", "3234.22", "34721");
    ...
    var eventObject = new PublicEventDBO(this.refs.eventName.value, this.refs.eventCategory.value,
